...
def trocar_conteudo(page, content):

    if hasattr(
        page,
        "conteudo",
    ):
        page.conteudo.content = content
        page.update()
        return

    import ui.main_layout as main_layout

    if main_layout.CONTENT_AREA:
        main_layout.CONTENT_AREA.content = content
        page.update()
        return
            ...
            content=ft.Column([
                ...
                ft.Row([
                    ...
                    ft.Column([
                        ...
                        ft.Text(
                            f"Celular: {celular or '-'} | E-mail: {email or '-'}"
                        )
