...
APP_SHORT_NAME = APP_CONFIG[
    "short_name"
]

APP_FULL_NAME = APP_CONFIG[
    "full_name"
]

SYSTEM_NAME = APP_CONFIG[
    "system_name"
]

INITIAL_DATA_FILE = get_env(
    "INITIAL_DATA_FILE",
    str(BASE_DIR / "config" / "initial_data.json")
)

LOC_TIPOS_FILE = get_env(
    "LOC_TIPOS_FILE",
    str(BASE_DIR / "config" / "local_tipos.json")
)
